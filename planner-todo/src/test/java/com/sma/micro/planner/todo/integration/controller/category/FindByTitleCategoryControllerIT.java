package com.sma.micro.planner.todo.integration.controller.category;
...
class FindByTitleCategoryControllerIT extends IntegrationTestBase {
    private static final TypeReference<List<CategoryPublicData>> listType = new TypeReference<>() {
    };
    @Autowired
    ...
    void findByTitle_shouldSucceedWith200() throws Exception {
        ...
        assertThat(categories).hasSize(3)
                .containsExactlyInAnyOrder(CATEGORY_PUBLIC_DATA_100, CATEGORY_PUBLIC_DATA_101, CATEGORY_PUBLIC_DATA_103);
    }
